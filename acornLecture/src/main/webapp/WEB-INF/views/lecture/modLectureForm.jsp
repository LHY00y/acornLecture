	...
	<form name="lectureForm" method="post" action="${contextPath }/lecture/modLecture.do?lecture_id=${lecture.lecture_id}"
		...
		<table border="0" align="center">
			...
			<tr>
				...
				<td colspan="4"><input type="text" size="67" maxlength="500" name="title" value="${lecture.lecture_title }" readonly="readonly"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td ><input type="number" min="0" name="count" value="${lecture.count }"></td>
			</tr>
		
			<tr style="height:100px; align:bottom;">
				<td></td>
				<td colspan="2">
					<input type="submit" value="강의수정" style="">
